...
public interface CountDao {
   ...
   // void insertGroup(Dbgroups group);
    ...
    Long insCount( Integer id_exercise, Integer id_word, int id_group, Boolean train, Date train_date);
    ...
    int upCount(Integer id_count, Integer id_exercise, Integer id_word, int id_group, Boolean train, Date train_date);

    default void insertOrUpdate(Integer id_exercise, Integer id_word, int id_group, Boolean train, Date train_date) {
